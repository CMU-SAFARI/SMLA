...
public:
    ...
    enum class Org;
    enum class Speed;
    SMLA_DIO(Org org, Speed speed);
    SMLA_DIO(const string& org_str, const string& speed_str);
    ...
    /* Prerequisite */
    function<Command(DRAM<SMLA_DIO>*, Command cmd, int)> prereq[int(Level::MAX)][int(Command::MAX)];

    // SAUGATA: added function object container for row hit status
    /* Row hit */
    function<bool(DRAM<SMLA_DIO>*, Command cmd, int)> rowhit[int(Level::MAX)][int(Command::MAX)];
    function<bool(DRAM<SMLA_DIO>*, Command cmd, int)> rowopen[int(Level::MAX)][int(Command::MAX)];
    ...
    /* Lambda */
    function<void(DRAM<SMLA_DIO>*, int)> lambda[int(Level::MAX)][int(Command::MAX)];
